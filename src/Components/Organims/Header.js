...
import "../Molecules/menuMobile.css";
		...
		{window.document.defaultView.innerWidth <= 768 &&
				window.document.defaultView.innerWidth >= 320
					? (
						...
						<MenuMobile pageWrapId={"page-wrap"} outerContainerId={"outer"} onClick={removeToken} cart={cart.length}/>
						
					)
					: (
						<header
			className={` bg-cyan-800 text-white body-font fixed top-0 left-0 right-0 z-20 px-4`}
			>
			<div
				className="container mx-auto flex  py-2 flex-col md:flex-row items-center"
				 id="outer">
				<NavLink
					to="/"
				...
				<nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l	flex flex-wrap items-center " id="page-wrap">
